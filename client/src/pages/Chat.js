            ...
            <div className="row">
              ...
              <div className="col-md-6 col-lg-7 col-xl-8">
                ...
                <div className="scrollbarh pt-3 pe-3" data-mdb-perfect-scrollbar="true" >
                  ...
                  <div className="d-flex flex-row justify-content-start">
                    <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava6-bg.webp"
                      ...
                      <p className="messagechat small p-2 ms-3 mb-1 rounded-3">Lorem ipsum
                        dolor
                  ...
                  <div className="d-flex flex-row justify-content-end">
                    <div>
                      <p className="user-message small p-2 me-3 mb-1 text-white rounded-3 bg-primary">Ut enim ad minim veniam,
                        quis
                  ...
                  <div className="d-flex flex-row justify-content-start">
                    <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava6-bg.webp"
                      alt="avatar 1" className='avatar' />
                    <div>
                      <p className="messagechat small p-2 ms-3 mb-1 rounded-3">Duis aute
                        irure
                  ...
                  <div className="d-flex flex-row justify-content-start">
                    <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava6-bg.webp"
                      alt="avatar 1" className="avatar" />
                    <div>
                      <p className="messagechat small p-2 ms-3 mb-1 rounded-3">Sed ut
                        perspiciatis
                  ...
                  <div className="d-flex flex-row justify-content-start">
                    <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava6-bg.webp"
                      alt="avatar 1" className="avatar" />
                    <div>
                      <p className="messagechat small p-2 ms-3 mb-1 rounded-3" >Neque porro
                        quisquam
                ...
                <div className="text-muted d-flex justify-content-start align-items-center pe-3 pt-3 mt-2">
                  <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-chat/ava6-bg.webp"
                    alt="avatar 3" className='avatar2' />
